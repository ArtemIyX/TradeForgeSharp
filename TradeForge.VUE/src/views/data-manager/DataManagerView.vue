<template>
  ...
  <CreateTickerModal ref="createTickerModalRef"/>
  <TickerExportModal ref="exportTickerModalRef"/>
...
import CreateTickerModal from "@/components/data-manager/create-ticker-modal/CreateTickerModal.vue";
import TickerExportModal from "@/components/data-manager/ticker-export-modal/TickerExportModal.vue";
...
const createTickerModalRef = ref<InstanceType<typeof CreateTickerModal> | null>(null);
const exportTickerModalRef = ref<InstanceType<typeof TickerExportModal> | null>(null);
...
const handleCreate = () => {
  console.log('Create');
  if (createTickerModalRef.value) {
    createTickerModalRef.value.open();
  }
};
...
const handleExport = () => {
  console.log('Export');
  if (exportTickerModalRef.value) {
    if (currentTicker.value) {
      exportTickerModalRef.value.open(currentTicker.value);
    }
  }
};
